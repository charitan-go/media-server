...
func (*Media) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case media.FieldName, media.FieldDescription, media.FieldCategory, media.FieldCountryCode, media.FieldStatus, media.FieldOwnerCharityReadableID:
			values[i] = new(sql.NullString)
		case media.FieldStartDate, media.FieldEndDate:
...
// to the Media fields.
func (pr *Media) assignValues(columns []string, values []any) error {
...
func (pr *Media) Value(name string) (ent.Value, error) {
...
// Medias is a parsable slice of Media.
type Medias []*Media
